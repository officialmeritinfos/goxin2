                ...
                <div class="card-body p-5">
                    ...
                    <form class="row g-3" method="post" action="{{route('investment.new')}}">
                        ...
                        <div class="form-group col-md-12">
                            <label for="inputAddress2">Minimum ($)</label>
                            <input type="text" class="form-control form-control-lg" id="inputAddress2"
                                   placeholder="Enter Amount to Invest" name="min" value="{{$package->minAmount}}" disabled>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="inputAddress2">Maximum ($)</label>
                            <input type="text" class="form-control form-control-lg" id="inputAddress2"
                                   placeholder="Enter Amount to Invest" name="max" value="{{$package->maxAmount}}" disabled>
                        </div>
                        <div class="form-group col-md-12">
